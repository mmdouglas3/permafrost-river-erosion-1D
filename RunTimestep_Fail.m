function [Tbank2, Hbank2, mf2, ic2, ts2, qw, M, E] = RunTimestep_Fail(dx, ...
    dt, ic, ts, mf, Cf, U, S, Tw, D, Tbank, Hbank, Lambda, Kic, Kts, rho_ic, ...
    rho_ts, cp_ic, cp_ts, Lf, K, yFail)
%% run timestep of bank thaw then erosion and failure
% inputs:
...
%   K = thawed sediment permeability (-)
...
elseif (ts2 - ic2) > yFail
    ts2 = ic2;              % thawed sediment thicker than yFail collapses
end
