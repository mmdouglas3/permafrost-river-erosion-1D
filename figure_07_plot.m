% make Figure 7 with results from modern Yukon hydrograph

clear

int = 1e4;
load('YukonHydrograph_modern.mat','Qw','Tw','EP','MP','icP','tsP','doy','dt');
Ebase = EP(1:int:end);
Ebase(Ebase<0) = 0;
...
ylabel('{\itE} (m/s)');
legend({'{\itE_{thaw}}','{\itE_{ent}}','{\itE}'},'Orientation','horizontal');
xlim([110,310]);
set(gca,'FontSize',16);
