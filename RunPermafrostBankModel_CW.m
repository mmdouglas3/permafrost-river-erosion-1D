function [Tres, mfr, ic, ts, qw, M, E, VNstability, CFLstability] = RunPermafrostBankModel_CW(Lambda, ...
    Cf, U, S, Tw, D, timesteps, dx, dt, bankdepth, Tbank0)
%% run permafrost bank erosion model with transitional or laminar flow
% inputs:
...
for t = 2:timesteps
    [T, H, mf, ic(t), ts(t), qw(t), M(t), E(t)] = RunTimestep_CW(dx, ...
