function [Tbank2, Hbank2, mf2, ic2, ts2, qw, M, E] = RunTimestep_CW(dx, ...
    dt, ic, ts, mf, Cf, U, S, Tw, D, Tbank, Hbank, Lambda, Kic, Kts, rho_ic, ...
    rho_ts, cp_ic, cp_ts, Lf)
%% run timestep of bank thaw then erosion with transitional or laminar flow
% inputs:
...
[~, Cf_b] = CWDarcyWeisbach(H, U, ks_b);        % bank coefficient of friction (-)
